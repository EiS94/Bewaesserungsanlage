...
def index():
    ...
    return render_template('index.html', plant1=plant1Status, temperatur=JsonWriter.getTemperatur(),
                           humidity=JsonWriter.getHumidityAir(), rain=rainStatus)
...
def wheaterData():
    ...
    file.close()
    return render_template('wheaterData.html', tempchart=resultTemp, humchart=resultHum, rainchart=resultRain,
                           illchart=resultIll)
